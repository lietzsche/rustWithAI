...
fn main() {
    ...
    println!("string reward box content length: {}", string_reward_box.content.len());
    let u32_reward_box: RewardBox<u32> = RewardBox {
        content: 100,
    };
    println!("u32 reward box content: {}", u32_reward_box.content);

    println!("player name: {} / attack power: {}", player.name(), player.attack_power());
    println!("monster name: {} / attack power: {}", monster.name(), monster.attack_power());
